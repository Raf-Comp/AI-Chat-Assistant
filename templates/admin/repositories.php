...
<div class="wrap">
    ...
    <div class="aica-repositories-container">
        <div class="aica-sidebar">
            <div class="aica-repo-sources">
                ...
                <ul class="aica-sources-list">
                    <li class="aica-source-item" data-source="saved">
            ...
            <div class="aica-repo-filters" id="aica-language-filter" style="display: none;">
                <h3><?php _e('Filtry języka', 'ai-chat-assistant'); ?></h3>
                <div class="aica-language-filters">
                    <?php
        ...
        <div class="aica-content">
            <div class="aica-content-header">
                <div class="aica-search-sort">
                    <div class="aica-search">
                    ...
                    <div class="aica-dark-mode-toggle" title="<?php _e('Przełącz tryb ciemny/jasny', 'ai-chat-assistant'); ?>">
                        <span class="dashicons dashicons-visibility"></span>
                    </div>
                </div>
            </div>
            
            <!-- Zapisane repozytoria -->
            <div id="saved-repositories" class="aica-repos-tab">
    ...
    <div id="aica-file-browser-modal" class="aica-modal">
                ...
                <div class="aica-file-browser-sidebar">
                    ...
                    <div class="aica-file-tree-container">
                        <div class="aica-loading-files">
                            <span class="dashicons dashicons-update" style="animation: aica-spin 1s linear infinite;"></span>
    ...
    <div id="aica-delete-dialog" class="aica-modal" style="display: none;">
